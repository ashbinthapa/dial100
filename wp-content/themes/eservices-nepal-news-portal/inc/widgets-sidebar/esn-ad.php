    ...
    class esn_ad_widget extends WP_Widget {
        ...
        function __construct() {
            ...
            /*Base ID of your widget*/
                ...
                __('1 ESN: Advertisement', 'eservices_nepal_news_portal'),
                /*Widget description*/
                array( 'description' => __( 'Add advertisement with different options.', 'eservices_nepal_news_portal' ), )
            );
        }
        ...
        public function form( $instance ) {
            ...
            <p class="description">
                <?php
                _e('You can use any size of Advertisement image but recommended to use proper image according to sidebar width.', 'eservices_nepal_news_portal' );
                ?>
            </p>
            <p>
                <label for="<?php echo $this->get_field_id( 'esn_ad_title' ); ?>"><?php _e( 'Title:', 'eservices_nepal_news_portal' ); ?></label>
            ...
            <h4 class="accordion-toggle"><?php _e( 'Advertisement Image', 'eservices_nepal_news_portal' ); ?></h4>
            <p>
                <label for="<?php echo $this->get_field_id('esn_ad_image'); ?>">
                    <?php _e( 'Select Advertisement Image', 'eservices_nepal_news_portal' ); ?>
                </label>
                <?php
                $esn_display_none = '';
                ...
                <span class="img-preview-wrap" <?php echo esc_attr( $esn_display_none ); ?>>
                    <img class="widefat" src="<?php echo esc_url( $esn_ad_image ); ?>" alt="<?php _e( 'Image preview', 'eservices_nepal_news_portal' ); ?>"  />
                ...
                <input type="button" value="<?php _e( 'Upload Image', 'eservices_nepal_news_portal' ); ?>" class="button media-image-upload" data-title="<?php _e( 'Select Ad Image','eservices_nepal_news_portal'); ?>" data-button="<?php _e( 'Select Ad Image','eservices_nepal_news_portal'); ?>"/>
                <input type="button" value="<?php _e( 'Remove Image', 'eservices_nepal_news_portal' ); ?>" class="button media-image-remove" />
            </p>
            <p>
                <label for="<?php echo $this->get_field_id( 'esn_ad_img_alt' ); ?>"><?php _e( 'Alt Text:', 'eservices_nepal_news_portal' ); ?></label>
            ...
            <p>
                <label for="<?php echo $this->get_field_id( 'esn_ad_link' ); ?>"><?php _e( 'Link URL:', 'eservices_nepal_news_portal' ); ?></label>
            ...
            <p>
                ...
                <label for="<?php echo $this->get_field_id( 'esn_ad_new_window' ); ?>"><?php _e( 'Open in new window', 'eservices_nepal_news_portal' ); ?></label>
            </p>
            <hr />
            <?php
        }
