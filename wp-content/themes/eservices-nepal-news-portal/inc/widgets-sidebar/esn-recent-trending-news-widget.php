<?php
/**
 * Custom Recent/Trending SideBar Widget
 */
	  ...
	  **/
		public function __construct() {
			$widget_options = array( 
			  ...
			  'description' => 'This widget display the news from the recent and trending post in sidebar.',
			);
			parent::__construct( 'esn_recent_trending_post_widget', '6 ESN:Recent and Trending', $widget_options );
		}
